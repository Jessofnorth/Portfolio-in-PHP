...
<section>
    ...
    <p class="center">Edit your post in the editor below. Title and content must be filled to publish.</p>
    <?= $errormsg ?>
    <?= $postpublished ?>
    <!-- form -->
    <form method="POST" action="editnews.php?edit=<?= $id ?>">
        <div class="postforms">
